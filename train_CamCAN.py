...
def parse_args():
    ...
    parser.add_argument('--image_size', default=(160, 192, 160), type=tuple, help='image size')
    ...
    parser.add_argument('--datapath', type=str, default='/data/yinsong/CamCAN_3D/training', help='training data path')
    parser.add_argument('--model_dir', type=str, default='../Model_CamCAN', help='model save directory')
    parser.add_argument('--log_dir', type=str, default='../Log_CamCAN', help='tensorboard log directory')
...
def train(args):
    ...
    image_paths = sorted(glob.glob(os.path.join(args.datapath, 'T1w/sub-CC*_T1w_unbiased.nii.gz')))
