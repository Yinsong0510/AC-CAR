...
def parse_args():
    ...
    parser.add_argument('--datapath', type=str, default='/data/yinsong/CamCAN_3D/testing', help='test data path')
    parser.add_argument('--model_dir', type=str, default='../Model_CamCAN/', help='model directory')
    ...
    parser.add_argument('--contrast_1', type=str, default='/T1w', help='contrast 1 folder')
    parser.add_argument('--contrast_2', type=str, default='/T2w', help='contrast 2 folder')
...
def test(args):
    ...
    name_1 = sorted(glob.glob(args.datapath + args.contrast_1 + '/sub-CC*_T1w_unbiased.nii.gz'))
    name_2 = sorted(glob.glob(args.datapath + args.contrast_2 + '/sub-CC*_T2w_unbiased.nii.gz'))
    label = sorted(glob.glob(args.datapath + '/seg/sub-CC*_T1w_unbiased_seg.nii.gz'))
    ...
    log_path = os.path.join(args.model_dir, 'Results_t1t2.txt')
